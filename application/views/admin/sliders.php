	...
	<div class="col-lg-12">
		...
		<div class="panel panel-default col-lg-4">
				...
				<div class="form-group">
					...
					<input type="hidden" class="hidden" name="slide_order" value="1" required placeholder="Enter Slide Order" >
				
				<div class="form-group">
					<label>Video ID</label>
					<input type="text" class="form-control" name="link_url" placeholder="Enter video ID from video url" required>
				</div>
